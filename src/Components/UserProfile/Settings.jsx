      ...
      <div class="bg-amber-100 w-screen h-screen">
        ...
        <div className="w-3/4 h-3/4 mx-auto">
          <div className="h-full w-full flex flex-col items-center justify-center ">
            <div className="justify-center grid grid-cols-1 gap-2 h-2/3 w-[100%] -mt-3 md:w-2/3  mx-auto ">
              ...
              <Link to="/user/settings/changepassword">
                <button type="button" className=" h-full w-full rounded-full text-xl sm:text-2xl font-bold bg-gradient-to-r bg-orange-500 hover:from-orange-600 hover:to-rose-500 ">
                  Change Password
                </button>
              </Link>
              <div></div>
              ...
              <Link to="/user/settings/deletewarning">
                <button type="button" className=" h-full w-full text-xl sm:text-2xl font-bold rounded-full bg-red-700 hover:bg-red-900 text-white"
                >
                  Delete Account
                </button>
              </Link>
